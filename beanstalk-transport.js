                  ...
                  tu.handle_request(seneca, data, listen_options, function(out) {
                    ...
                    beanstalk_out.put(
                      ...
                      outstr, function(err, outjobid) {
                        console.log(require('util').inspect('LISTEN JOBID: ' + outjobid, {
                          colors: true,
                          color: true
                        }));
                ...
                beanstalk_out.put(
                  ...
                  outstr, function(err, outjobid) {
                    var clear = function(jobid) {
                      return function() {
                        console.log(require('util').inspect('TIMEOUT JOBID: ' + outjobid, {
                          colors: true,
                          color: true
                        }));
                        beanstalk_out.destroy(jobid, function(err) {
                          ...
                          //return out_err('destroy/' + jobid, err);
                          } else {
                            ...
                            console.log(require('util').inspect('DESTROY JOBID: ' + outjobid, {
                              colors: true,
                              color: true
                            }));
                          }
                    ...
                    console.log(require('util').inspect('CLIENT JOBID: ' + outjobid, {
                      colors: true,
                      color: true
                    }));
